  ...
  return (
    <section className="py-24 lg:py-32 bg-brand-charcoal relative">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Payment card */}
        <div className="glass border border-brand-border rounded-3xl p-8 sm:p-10 hover:border-brand-green/30 transition-all duration-300">
          {/* Icon */}
          <div className="w-14 h-14 rounded-2xl bg-brand-green/10 flex items-center justify-center mx-auto mb-6">
            <DollarSign size={26} className="text-brand-green" aria-hidden="true" />
          </div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed mb-8 max-w-sm mx-auto">
            Whether you&apos;re paying for completed lawn care services or simply want to encourage a hardworking young entrepreneur, every contribution helps Mali continue growing his business.
          </p>
          ...
          >
            {/* Cash App icon (SVG — no external dependency needed) */}
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
          ...
          {/* Supporting message */}
          <p className="text-gray-500 text-xs leading-relaxed mt-6 max-w-sm mx-auto">
            Every payment helps purchase equipment, supplies, and tools so Mali can continue providing reliable service throughout the community. Thank you for supporting a young entrepreneur.
          </p>
        </div>
      </div>
    </section>
